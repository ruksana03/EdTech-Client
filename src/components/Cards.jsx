...
<div className="card bg-base-100 shadow-xl relative mx-4 border border-emerald-950 h-96">
  ...
  <div className="card-body">
    ...
    <p className="overflow-hidden whitespace-nowrap overflow-ellipsis">{details}</p>
    <div className="card-actions mt-3 flex justify-between items-center">
      <h5 className="font-semibold">$ {price}</h5>
     <Link to={`/details/${_id}`}> <button className="px-3 py-2 btn-style rounded-2xl">Details</button></Link>
    </div>
  </div>
</div>
