...
const DSidebar = ({ handleReverse, isActive, handleToggle }) => {
  ...
  return (
    <div className=" border-e-2 relative">
      <div className={`z-10 fixed pt-3 bg-white overflow-y-auto w-full h-screen px-2 inset-y-0 left-0 transform ${isActive && ' transition-all duration-200'} lg:translate-x-0 dark:text-white dark:bg-zinc-800 transition duration-200 ease-in-out `}>
        {/* <DSidebarMenu/> */}
