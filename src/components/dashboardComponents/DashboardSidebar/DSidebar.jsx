...
const DSidebar = ( {handleReverse, isActive}) => {
    ...
    return (
        ...
        <div>
          ...
          <div className={`z-10 fixed pt-3 bg-white overflow-y-auto  w-[240px] h-screen px-2 inset-y-0 left-0 transform ${isActive ? 'transition-all duration-200 md:w-[100px] w-[100px] px-0' : 'lg:translate-x-0'} dark:text-white dark:bg-zinc-800 transition duration-200 ease-in-out`}>
            {/* <DSidebarMenu/> */}
