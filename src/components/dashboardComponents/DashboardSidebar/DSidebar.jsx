...
const DSidebar = ({ handleReverse, isActive }) => {
  ...
  return (
    <div className="w-full">
        ...
        <div className={`z-10 fixed pt-3 bg-white overflow-y-auto w-[48px] md:w-[140px] lg:w-[150px] h-screen px-2 inset-y-0 left-0 transform ${isActive && ' transition-all duration-200 w-[calc(100%-250px)] md:w-[80px] lg:w-[120px]'} lg:translate-x-0 dark:text-white dark:bg-zinc-800 transition duration-200 ease-in-out`}>
          {/* <DSidebarMenu/> */}
