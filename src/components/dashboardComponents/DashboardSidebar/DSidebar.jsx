...
const DSidebar = ({ handleReverse, isActive, handleToggle }) => {
  return (
    <div className=" border-e-2 relative">
      <div className={`z-10 fixed pt-3 p__opensans overflow-y-auto w-full h-screen px-2 inset-y-0 left-0 transform bg-black text-white ${isActive && ' transition-all duration-200'} lg:translate-x-0 transition duration-200 ease-in-out `}>
        {/* <DSidebarMenu/> */}
