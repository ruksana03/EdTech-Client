...
const AdminMenu = ({ isActive }) => {
    const adminLinks = ['/allUsers', '/applications', '/online-applications', '/allNotices', '/allBlogs', '/allCourses', '/quiz', '/allPaymentInfo', '/subscriber', '/all-feedback', '/allpartners', '/add-member', '/add', '/add-offer', '/dashboard'];
    ...
    const icons = [
        ...
        <MdFeedback key={adminLinks[10]} className="text-2xl" />,
