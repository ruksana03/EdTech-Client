...
const Teacher = () => {
  ...
  return (
    <div className='w-full section-container mx-auto rounded-lg flex flex-col items-center justify-center my-12'>
      {/* First Section */}
      <div className='w-full h-auto flex items-center justify-center flex-col md:flex-row lg:flex-row lg:justify-evenly bg-gradient-to-b from-second to-first dark:from-second dark:to-black'>
      ...
      {/* Second Section */}
      <div className='w-full h-auto flex items-center justify-center flex-col md:flex-row-reverse lg:flex-row-reverse bg-gradient-to-b from-second to-first dark:from-black dark:to-second '>
        <div className='w-full h-full md:w-1/2 relative overflow-hidden'>
          {/* Parallax Image 2 */}
          <img
            className='w-full h-full object-cover transform scale-110 md:scale-100 lg:scale-100 transition-transform duration-500 ease-in-out'
