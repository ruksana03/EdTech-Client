...
const Notices = () => {
  ...
  studentRefetch();
  useEffect(() => {
    const searchItem = userNotices.filter((item) =>
        ...
        <div className="flex items-center justify-center w-full my-5">
          <div className="relative w-full md:w-1/2 lg:w-1/2 flex items-center gap-1 dark:text-gray-400">
            ...
            <input
              ...
              className="text=[17px]dark:bg-zinc-600 dark:text-gray-400 dark:bg-zinc-800 appearance-none input border-2 text-[17px] border-gray-200 rounded w-full py-4 px-4 leading-tight focus:outline-none focus:bg-white focus:border-first"
              name="search"
