  ...
  console.log(courses);
    ...
    return (
        <div className=" w-full">
            <h1 className="w-full text-2xl text-center flex items-center justify-center gap-2 font-bold">Create Your Notice <RiNotificationBadgeFill className="text-3xl text-first" /></h1>
            ...
            <form onSubmit={handleSubmit} className="p-5 w-full h-auto md:w-2/3 lg:w-1/2 mx-auto mt-5">
                <div className="space-y-3 mt-5">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <select className=" border border-gray-300 text-black focus:outline-none focus:bg-white focus:border-first leading-tight input" name="courseName" required>
