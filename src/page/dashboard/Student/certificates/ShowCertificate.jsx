    ...
    return (
        <div className='mt-14 p-5'>
            <div className='flex items-center justify-center mb-5'>
                <button onClick={handleSubmit} type='submit' className='btn btn-success'>Download png</button>
            </div>
            <div>
                <div id='certificate' ref={componentRef} className='w-full h-full certificate relative'>
                    ...
                    <img src='https://i.ibb.co/N6gZBXk/certificate.png' alt="certificate" className='w-full h-full' />
