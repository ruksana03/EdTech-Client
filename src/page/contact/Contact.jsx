  ...
  return (
    <div className="">
      ...
      <figure className="w-full h-[45vh]">
        <img
          src={"https://i.ibb.co/Gc059xG/contact.jpg"}
          alt="contact-image"
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-10 items-center justify-center w-full my-20 section-container px-10 ">
        ...
        <div className="cols-span-12 md:col-span-8 lg:col-span-8 p-5">
          ...
          <p className="my-8 text-center p__opensans">
          ...
          <div className="mt-8">
            ...
            >
                ...
                <div className="md:w-full mt-2">
                  <input
                    className="bg-gray-200
                                    dark:bg-zinc-600 appearance-none input border-2 border-gray-200 rounded w-full py-4 px-4  leading-tight focus:outline-none text-[17px] focus:bg-white focus:border-first"
                    id="inline-password"
                    name="from_phone"
                    type="number"
              ...
              <div className="flex items-end justify-end">
                <button
                  className="shadow btn-style  transition-all focus:shadow-outline focus:outline-none  "
                  type="submit"
                >
                  Send Message
                </button>
