        ...
        <div className="text-white section-container">
            ...
            <div className="space-y-3 my-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 w-11/12 mx-auto ">
                    <div className="bg-purple-700 rounded-full py-2 flex items-center justify-center">Interactive live classes</div>
                    <div className="bg-purple-700 rounded-full py-2 flex items-center justify-center">
                        Instant Class Quiz</div>
                    <div className="bg-purple-700 rounded-full py-2 flex items-center justify-center">Question and answer solution</div>
                    <div className="bg-purple-700 rounded-full py-2 flex items-center justify-center">
                        Full syllabus cover</div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 w-full mx-auto  ">
                    <div className="bg-purple-700 py-2 rounded-full flex items-center justify-center">Regular homework</div>
                    <div className="bg-purple-700 py-2 rounded-full flex items-center justify-center">
                        written test</div>
                    <div className="bg-purple-700 py-2 rounded-full flex items-center justify-center">Study material</div>
                    <div className="bg-purple-700 py-2 rounded-full flex items-center justify-center">
                        Lecture sheet</div>
                    <div className="bg-purple-700 py-2 md:hidden md rounded-full block lg:block text-center items-center justify-center">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-5">
                <div className="border border-white bg-black text-white relative shadow-xl w-full flex flex-col lg:flex-row h-auto lg:py-8 lg:w-1/2 rounded-md py-8 lg:h-auto xl:h-64">
                    ...
                    <div className="lg:flex-1 mt-3 px-5 lg:pl-3 pl-16">
                        ...
                        <h1 className="text-xl font-bold">Mahfuz Rahman</h1>
                        <p>Gopalganj High School, Gopalganj</p>
                    </div>
                </div>
                <div className="border border-white bg-black text-white relative shadow-xl w-full flex flex-col lg:flex-row h-auto lg:py-8 lg:w-1/2 rounded-md py-8 lg:h-auto xl:h-64">
                    <FaQuoteLeft className="absolute left-4 top-40 md:top-40 md:left-4 lg:top-9 lg:left-24 xl:top-10 xl:left-24 2xl:left-24 text-4xl" />
                    ...
                    <div className="lg:flex-1 mt-3 lg:pl-3 pl-16 space-y-2">
                        <p>I did very well in the evaluation festival by taking online batch classes. Especially the daily homework and lecture sheets helped a lot because everything was given very simply in the lecture sheets.</p>
                        <h1 className="text-xl font-bold">Jenny Wellious</h1>
                        <p>Oxford Ideal Collage, London</p>
                    </div>
                </div>
            </div>
        </div>
